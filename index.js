...
app.use(cors({
  origin: [
    "http://localhost:5173",
    "https://simple-firebase-5adbe.web.app",
    "https://simple-firebase-5adbe.firebaseapp.com"
  ],
  credentials: true
}));
...
async function run() {
  try {
    ...
    app.get('/jobs', async (req, res) => {
      // console.log('Now inside the api callback', req.query);
...
app.listen(port, () => {
  console.log(`Jobs are waiting at port: ${port}`);
})